...
// All 12 active members (excluding Marshall's duplicate)
const MEMBERS = [
  { name: "AJ Hoover", email: "ajhoover@mac.com" },
  { name: "Dan Del Monte", email: "dan@delmontebuilders.com" },
  { name: "Dan Billingsley", email: "dan@heatwaveflorida.com" },
  { name: "Darian", email: "darianb280@hotmail.com" },
  { name: "Henrico", email: "henklop@gmail.com" },
  { name: "Joaquin Lescano", email: "lescano0456@gmail.com" },
  { name: "Joey D", email: "joey@mcmdlusso.com" },
  { name: "Marshall Wilkinson", email: "marshall@marshallwilkinson.com" },
  { name: "Michael E", email: "michael@mecontractingpros.com" },
  { name: "Nathan Oliveira", email: "nathan@olivetreebuilds.ca" },
  { name: "Ronnie Silva", email: "office@sageconstructiondevelopment.com" },
];

async function main() {
  console.log(`Sending EOS deck announcement to ${MEMBERS.length} members...\n`);
