...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="background-color:#0F1117;border-radius:16px;padding:32px 28px;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
      <tr><td style="padding:12px 16px;background-color:rgba(212,145,92,0.06);border-left:2px solid rgba(212,145,92,0.4);border-radius:0 8px 8px 0;margin-bottom:8px;">
...
const textVersion = `Sunday Bootcamp — Here's the Agenda
...
JOIN DISCORD: There are a few members who haven't joined the Discord yet or introduced themselves. We want to meet you. We want you to get the most out of this opportunity. Get in there and introduce yourself.

TEMPLATE LIBRARY: Updated weekly with detailed, high-level resources. Log into the portal and take advantage of everything in there.
...
async function main() {
  try {
    const { data, error } = await resend.emails.send({
      ...
      subject: "🔥 PREVIEW v2 — Sunday Bootcamp Agenda (Fixed Mobile Layout)",
      html: html,
      text: textVersion,
    });
