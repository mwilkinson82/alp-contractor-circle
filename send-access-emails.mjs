        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 0 32px;">
              ...
              <p style="margin:0 0 20px;font-size:16px;color:rgba(245,240,232,0.75);line-height:1.7;">
                If you have any issues, email me at <a href="mailto:marshall@marshallwilkinson.com" style="color:#C9A84C;">marshall@marshallwilkinson.com</a> and I'll get it sorted.
              </p>
...
const recipients = [
  { firstName: "Michael", email: "michael@mecontractingpros.com" },
  { firstName: "Joaquin", email: "lescano0456@gmail.com" },
];
...
for (const recipient of recipients) {
  const result = await resend.emails.send({
    ...
    subject: "Your Contractor Circle Access Is Live",
    html: buildHtml(recipient.firstName),
  });
  console.log(`Sent to ${recipient.firstName} (${recipient.email}):`, result.data?.id ?? result.error);
}
