...
const faqs = [
  ...
  },
  {
    ...
    answer: "Sundays bi-weekly at 5 PM ET, Marshall leads a live group call (starting March 30). These rotate between hot seats (bring your real challenges), Q&A sessions, and focused teaching on topics like sales, estimating, hiring, and operations. You'll leave every call with something actionable.",
  },
  {
