...
import { Calendar, BarChart3, GraduationCap, FileText, Users, Video } from "lucide-react";
...
const timelineItems = [
  {
    ...
    subtitle: "Every Other Sunday · 5 PM ET · Starting Mar 29",
    headline: "You're in the room with Marshall.",
    body: "Every other Sunday, you're on a live call with Marshall and contractors who are actually building. No theory. No fluff. Bring your real challenges — leave with a clear next move. Hot seats, Q&A, and focused teaching that moves the needle.",
    accent: "ember",
  ...
  },
  {
    ...
    headline: "Expert eyes on your numbers before you present.",
    body: "Bring your actual bids, proposals, and deals. Marshall reviews them live — breaking down what's working, what's leaving money on the table, and exactly how to position for the close. Members have added six figures to single deals from one session.",
    accent: "blue",
  ...
  },
  {
    ...
    headline: "One topic. Mastered.",
    body: "Every month, one focused deep-dive — estimating, hiring, sales process, marketing, operations. These aren't webinars. They're intensive working sessions where you leave with a system you can implement the same week.",
    accent: "ember",
  ...
  },
  {
    ...
    body: "SOPs, contracts, estimating spreadsheets, change order templates, subcontractor agreements, and operational checklists — built from $2.5B+ in real-world execution. These are the actual documents used in high-performing contracting operations. Download and deploy.",
    accent: "blue",
