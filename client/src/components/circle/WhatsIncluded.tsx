...
const timelineItems = [
  {
    ...
    body: "Sundays bi-weekly, you're on a live call with Marshall and contractors who are actually building. No theory. No fluff. Bring your real challenges — leave with a clear next move. Hot seats, Q&A, and focused teaching that moves the needle.",
    accent: "ember",
