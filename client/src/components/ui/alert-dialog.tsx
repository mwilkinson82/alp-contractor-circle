...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-3 sm:flex-row sm:justify-end pt-4 border-t border-white/10",
        className
      )}
      {...props}
    />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn("text-gray-300 text-sm font-medium leading-relaxed", className)}
      {...props}
    />
  );
}
