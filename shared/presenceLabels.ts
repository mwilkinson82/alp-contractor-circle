const PRESENCE_PAGE_LABELS: Array<{ prefix: string; label: string; work: string }> = [
  ...
  { prefix: "/portal/schedule/", label: "ConstructLine Baseline", work: "Working inside a Baseline schedule" },
  { prefix: "/portal/schedule", label: "Baseline", work: "Reviewing CPM schedules" },
