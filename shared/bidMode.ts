export const TAKEOFF_BID_MODES = ["full_gc", "trade_package", "fast_scope_check"] as const;
...
export const BID_MODE_BEHAVIORS: Record<TakeoffBidMode, BidModeBehavior> = {
  full_gc: {
    ...
    reviewSurface: "Broad trade estimate with active rows organized for GC review.",
  ...
  fast_scope_check: {
    ...
    description: "Speed-first bid read for likely scope, risk, and budget signals.",
    reviewSurface: "Lean readout of likely scope items and visible risk/boundary rows.",
